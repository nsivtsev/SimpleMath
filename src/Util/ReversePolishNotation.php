...
class ReversePolishNotation
{
     ...
     * Взято из https://ru.wikiversity.org/wiki/Обратная_польская_запись:_примеры_реализации#PHP с некоторыми доработками
     * @param $str
     * @return string
     * @throws Exception
     */
    ...
    /**
     * @param $str
     * @param bool $postfix Является ли $str строкой в посфиксной записи
     * @return mixed
     * @throws Exception
     */
    public function calc($str, bool $postfix = false)
    {
        if (!$postfix)
            $str = $this->infixToPostfix($str); //привести строку к постфиксной записи
